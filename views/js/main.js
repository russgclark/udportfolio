...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var pizzaContainerCount = pizzaContainer.length;
    var dx = determineDx(pizzaContainer[0], size);
    var newwidth = (pizzaContainer[0].offsetWidth + dx) + 'px';
    // Placed variable assignments above loop and reduced querySelectorAll usage to one instance
      for (var i = 0; i < pizzaContainerCount; i++) {
...
// Removed scrollTop calculation and var top assignment from loop for efficiency
